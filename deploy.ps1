...
$OPENROUTER_MODEL = [System.Environment]::GetEnvironmentVariable("OPENROUTER_MODEL")
if (-not $OPENROUTER_MODEL) { $OPENROUTER_MODEL = "openai/gpt-oss-120b:free,google/gemini-2.0-flash-001,google/gemini-flash-1.5" }
